    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <textarea class="link-txt" style="width:90%; margin-right:10px; border: none; overflow: hidden; height: 17px;" spellcheck='false' readonly rows="1"><?php echo $link; ?></textarea>
